...
public class ElevatorTest {
    ...
    @Test
    public void gouUp() throws InterruptedException {
    ...
    public void goUpAndCallDown() throws InterruptedException {
        ...
        String actualStateInfo = elevator.getHistory();
        assertEquals("[Ground Floor Open, Ground Floor Closed, First Floor Closed, First Floor Open, First Floor Closed, First Floor Open, First Floor Closed, Ground Floor Closed, Ground Floor Open]", actualStateInfo);
    }
