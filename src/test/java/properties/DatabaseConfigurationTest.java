...
class DatabaseConfigurationTest {
    ...
    public void testInvalid(){
        Exception ex = assertThrows(IllegalArgumentException.class,()-> new DatabaseConfiguration((new File("2351354154"))));
    ...
    public void testExternalFile()throws IOException {
        ...
        try(PrintWriter printWriter = new PrintWriter(file, "UTF-8");
            ...
            printWriter.println("db.schema = ütvefúrógpép");
        }
        ...
        assertEquals("ütvefúrógpép", databaseConfiguration.getSchema());
